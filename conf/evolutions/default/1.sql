...
create table authenticated_user (
  ...
  mobile_verification_code_sent tinyint(1) default 0 not null,
  mobile_verification_code      varchar(255),
  mobile_verification_code_generated tinyint(1) default 0 not null,
  ...
  email_verification_sent       tinyint(1) default 0 not null,
  email_verification_ticket     varchar(255),
  email_verification_ticket_generated tinyint(1) default 0 not null,
  email_verification_ticket_date_generated datetime,
  disabled                      tinyint(1) default 0 not null,
  probation                     tinyint(1) default 0 not null,
  email_bounced                 tinyint(1) default 0 not null,
  proxy_email_id                varchar(255),
  session_uuid                  varchar(255),
  publishable_uuid              varchar(255),
  force_change_password         tinyint(1) default 0 not null,
  last_login                    datetime,
  password_reminder             varchar(255),
  password_reset_required       tinyint(1) default 0 not null,
  version                       bigint not null,
  created_at                    DATETIME not null,
  updated_at                    DATETIME not null,
...
create table image_meta (
  ...
  disabled                      tinyint(1) default 0 not null,
  description                   varchar(255),
  first                         tinyint(1) default 0 not null,
...
create table inbox_message (
  ...
  receiver_id                   bigint,
  message                       TEXT,
  seen_by_sender                tinyint(1) default 0 not null,
  seen_by_receiver              tinyint(1) default 0 not null,
  deleted                       tinyint(1) default 0 not null,
  spam                          tinyint(1) default 0 not null,
  saved                         tinyint(1) default 0 not null,
...
create table open_house (
  ...
  rental                        tinyint(1) default 0 not null,
  description                   TEXT,
...
create table sms (
  ...
  orphan                        tinyint(1) default 0 not null,
  version                       bigint not null,
  created_at                    DATETIME not null,
  updated_at                    DATETIME not null,
...
create table security_role (
  ...
  current                       tinyint(1) default 0 not null,
  name                          varchar(255),
  public_facing                 tinyint(1) default 0 not null,
...
create table zillow_feed_history (
  ...
  discarded_listings            integer not null,
  relevant_listings             integer not null,
  relevant_rentals              integer not null,
  relevant_sales                integer not null,
