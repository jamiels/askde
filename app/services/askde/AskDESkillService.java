...
public class AskDESkillService extends BaseAlexaService {
	...
	public SpeechletResponse getWelcomeMessage(SpeechletRequestEnvelope<LaunchRequest> requestEnvelope) {
		String speechText = "Hi and welcome to Ask Douglas Elliman. For more information on us, visit us at Elliman.com. I've just sent you a card to your Alexa app detailing how to use the Ask Douglas Elliman Service. Thank you and see you soon";
        String cardText = "To use the Ask Douglas Elliman service, simply choose one of the 3 ways to ask: Ask Douglas Elliman when is the next open house in Chelsea OR Alexa, ask Douglas Elliman when is the next open house in zip code 10012 OR Alexa, ask Douglas Elliman when is the next open house near me (Zip code permissions need to be enabled in your Alexa app for the Ask Douglas Elliman skill. Enjoy!";
